...
@Configuration
@ComponentScan(basePackages = "com.bhuwan")
@PropertySource(value="com/bhuwan/commons/jdbc.properties")
@ImportResource(locations = "com/bhuwan/cfgs/applicationContext.xml")
